...
export const Stratagems: Record<string, IStratagem[]> = {
  'Patriotic Adminstration Center': [
    ...
    new Stratagem('EAT-17 Expendable Anti-Tank', ['down', 'left', 'right', 'up', 'down'], 'EAT-17icon.svg', 'Supply'),
    new Stratagem('GR-8 Recoilless Rifle', ['down', 'left', 'right', 'right', 'left'], 'GR-8icon.svg', 'Supply'),
    new Stratagem('FLAM-40 "Incinerator" Flamethrower', ['down', 'left', 'down', 'right', 'left'], 'FLAM-40icon.svg', 'Supply'),
    ...
    new Stratagem('FAF-14 Spear', ['down', 'left', 'down', 'up', 'up', 'right'], 'FAF-14icon.svg', 'Supply'),
  ],
  'Orbital Cannons': [
  ...
  'Engineering Bay': [
    ...
    new Stratagem('B-1 Supply Pack', ['down', 'up', 'down', 'down', 'right'], 'B-1icon.svg', 'Supply'),
    new Stratagem('GL-21 Grenade Launcher', ['down', 'left', 'down', 'up', 'up', 'down'], 'GL-21icon.svg', 'Supply'),
  ...
  'Mission Stratagems': [
    ...
    new Stratagem('SEAF Artillery', ['left', 'up', 'up', 'down'], 'Artillery.svg', 'Mission'),
    new Stratagem('Seismic Probe', ['up', 'up', 'left', 'right', 'down', 'down'], 'SeismicProbeIcon.svg', 'Mission'),
    new Stratagem('Prospecting Drill', ['down', 'down', 'down', 'up', 'up'], 'DrillingIcon.svg', 'Mission'),
